...
import { AppCtx, AppProvider, useApp } from "./context/AppContext";
...
function AppGate({ toast }) {
  const { session, role, roleLoaded } = useApp();
  ...
  return <Layout toast={toast} user={session?.user} />;
}
