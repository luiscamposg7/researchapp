        ...
        <div className="mb-6">
          ...
          {form.title.trim() && (
            <div className="flex items-center gap-2 min-w-0">
              ...
              <button type="button" title="Copiar enlace" onClick={() => navigator.clipboard.writeText(`${window.location.origin}/research/${toSlug(form.title)}`)} style={{ width: 32, height: 32 }} className={`hidden sm:flex items-center justify-center rounded-lg border flex-shrink-0 ${d ? "bg-gray-800 border-gray-700 text-gray-400 hover:bg-gray-700 hover:text-gray-200" : "bg-white border-gray-300 text-gray-500 hover:bg-gray-50 hover:text-gray-700"}`}>
